#define COHERENT_UI_EVALUATION_UNITY3D
...
public class CoherentUISystem : MonoBehaviour
{
	...
	private void StartActivator()
	{
		...
		if (activationCode != 0)
		{
			Debug.LogError("Could not activate Coherent UI when running built game. Please contact support@coherent-labs.com and attach the \"{0}/Coherent_UI.log\" file");
		}
	}
